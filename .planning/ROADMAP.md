...
- [ ] **Phase 1: CAS Foundation** - Block store, hash, chunking traits, and dedup index with bloom filter
...
- [ ] 01-03-PLAN.md — LocalDiskStore and MemDedupIndex with bloom filter
...
|-------|----------------|--------|-----------|
| 1. CAS Foundation | 0/3 | Planning complete | - |
