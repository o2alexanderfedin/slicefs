...
use crate::handlers::{
    AttrResult, CreateResult, DataResult, EmptyResult, EntryResult, LockResult, OpenResult,
    ReaddirResult, StatfsResult, WriteResult, XattrResult, handle_create, handle_flush,
    handle_fsync, handle_getattr, handle_getlk, handle_getxattr, handle_link, handle_listxattr,
    handle_lookup, handle_mkdir, handle_mknod, handle_open, handle_read, handle_readdir,
    handle_readlink, handle_release, handle_removexattr, handle_rename, handle_rmdir,
    handle_setattr, handle_setxattr, handle_statfs, handle_symlink, handle_unlink, handle_write,
};
use crate::util::ts;
...
impl Filesystem for SliceFsFilesystem {
    fn init(&mut self, _req: &Request, config: &mut KernelConfig) -> io::Result<()> {
        eprintln!(
            "[{}][FUSE] init: ENTRY — requesting capabilities: FUSE_ATOMIC_O_TRUNC, FUSE_BIG_WRITES",
            ts()
        );
        ...
        eprintln!(
            "[{}][FUSE] init: EXIT ok — FUSE_ATOMIC_O_TRUNC={:?}, FUSE_BIG_WRITES={:?}, store_path={:?}, auto_snapshot={}",
            ts(),
            r1.is_ok(),
            r2.is_ok(),
            self.store_path,
    ...
    fn destroy(&mut self) {
        eprintln!(
            "[{}][FUSE] destroy: ENTRY — auto_snapshot={}",
            ts(),
            self.auto_snapshot
        );
    ...
    fn getattr(&self, _req: &Request, ino: INodeNo, _fh: Option<FileHandle>, reply: ReplyAttr) {
        ...
        match handle_getattr(self, ino.0) {
            AttrResult::Ok(attr) => {
                eprintln!(
                    "[{}][FUSE] getattr: EXIT ino={} -> ok size={}, mode={:#o}, uid={}, gid={}, nlink={}, kind={:?}",
                    ts(),
                    ino.0,
                    attr.size,
                    attr.perm,
    ...
    fn lookup(&self, _req: &Request, parent: INodeNo, name: &OsStr, reply: ReplyEntry) {
        ...
        match handle_lookup(self, parent.0, name_str) {
            EntryResult::Ok(child_ino, attr) => {
                eprintln!(
                    "[{}][FUSE] lookup: EXIT parent={}, name={:?} -> found ino={}, size={}, mode={:#o}, kind={:?}",
                    ts(),
                    parent.0,
                    name,
                    child_ino,
            ...
            EntryResult::Error(errno) => {
                eprintln!(
                    "[{}][FUSE] lookup: EXIT parent={}, name={:?} -> error {}",
                    ts(),
                    parent.0,
                    name,
                    errno
    ...
    fn readdir(
        ...
        eprintln!(
            "[{}][FUSE] readdir: ENTRY ino={}, fh={}, offset={}",
            ts(),
            ino.0,
            _fh.0,
            offset
        ...
        match handle_readdir(self, ino.0, offset) {
            ReaddirResult::Ok(entries) => {
                ...
                eprintln!(
                    "[{}][FUSE] readdir: EXIT ino={} -> ok, total_entries={}, returned={}",
                    ts(),
                    ino.0,
                    total,
                    returned
    ...
    fn read(
        ...
        eprintln!(
            "[{}][FUSE] read: ENTRY ino={}, fh={}, offset={}, size={}, flags={:#x}",
            ts(),
            ino.0,
            _fh.0,
            offset,
        ...
        match handle_read(self, ino.0, offset, size) {
            DataResult::Ok(data) => {
                eprintln!(
                    "[{}][FUSE] read: EXIT ino={}, fh={} -> ok, {} bytes returned",
                    ts(),
                    ino.0,
                    _fh.0,
                    data.len()
    ...
    fn open(&self, _req: &Request, ino: INodeNo, flags: OpenFlags, reply: ReplyOpen) {
        ...
        eprintln!(
            "[{}][FUSE] open: ENTRY ino={}, flags={:#x}, acc_mode={}, O_TRUNC={}, O_APPEND={}",
            ts(),
            ino.0,
            flags.0,
            acc_str,
        ...
        match handle_open(self, ino.0, flags.0) {
            OpenResult::Ok(fh, is_write) => {
                eprintln!(
                    "[{}][FUSE] open: EXIT ino={} -> ok, fh={}, writable={}",
                    ts(),
                    ino.0,
                    fh,
                    is_write
    ...
    fn opendir(&self, _req: &Request, _ino: INodeNo, _flags: OpenFlags, reply: ReplyOpen) {
        eprintln!(
            "[{}][FUSE] opendir: ENTRY ino={}, flags={:#x}",
            ts(),
            _ino.0,
            _flags.0
        );
    ...
    fn release(
        ...
        eprintln!(
            "[{}][FUSE] release: ENTRY ino={}, fh={}, flush={}, flags={:#x}, lock_owner={:?}",
            ts(),
            ino.0,
            fh.0,
            flush,
            _flags.0,
            _lock_owner.map(|l| l.0)
        );
        match handle_release(self, ino.0, fh.0) {
            EmptyResult::Ok => {
                eprintln!(
                    "[{}][FUSE] release: EXIT ino={}, fh={} -> ok",
                    ts(),
                    ino.0,
                    fh.0
                );
            ...
            EmptyResult::Error(e) => {
                eprintln!(
                    "[{}][FUSE] release: EXIT ino={}, fh={} -> error {}",
                    ts(),
                    ino.0,
                    fh.0,
                    e
    ...
    fn releasedir(
        ...
        eprintln!(
            "[{}][FUSE] releasedir: ENTRY ino={}, fh={}, flags={:#x}",
            ts(),
            _ino.0,
            _fh.0,
            _flags.0
    ...
    fn flush(
        ...
        eprintln!(
            "[{}][FUSE] flush: ENTRY ino={}, fh={}, lock_owner={}",
            ts(),
            ino.0,
            fh.0,
            _lock_owner.0
    ...
    fn fsync(
        ...
        eprintln!(
            "[{}][FUSE] fsync: ENTRY ino={}, fh={}, datasync={}",
            ts(),
            ino.0,
            fh.0,
            _datasync
    ...
    fn statfs(&self, _req: &Request, _ino: INodeNo, reply: ReplyStatfs) {
        ...
        match handle_statfs(self) {
            StatfsResult::Ok(blocks, bfree, bavail, files, ffree, bsize) => {
                eprintln!(
                    "[{}][FUSE] statfs: EXIT ino={} -> ok, blocks={}, bfree={}, bavail={}, files={}, ffree={}, bsize={}",
                    ts(),
                    _ino.0,
                    blocks,
                    bfree,
    ...
    fn getxattr(&self, _req: &Request, ino: INodeNo, name: &OsStr, size: u32, reply: ReplyXattr) {
        eprintln!(
            "[{}][FUSE] getxattr: ENTRY ino={}, name={:?}, size={}",
            ts(),
            ino.0,
            name,
            size
        ...
        match handle_getxattr(self, ino.0, name_str, size) {
            XattrResult::Size(sz) => {
                eprintln!(
                    "[{}][FUSE] getxattr: EXIT ino={}, name={:?} -> size_query, value_len={}",
                    ts(),
                    ino.0,
                    name,
                    sz
            ...
            XattrResult::Data(value) => {
                eprintln!(
                    "[{}][FUSE] getxattr: EXIT ino={}, name={:?} -> ok, value_len={}",
                    ts(),
                    ino.0,
                    name,
                    value.len()
            ...
            XattrResult::Error(_) => {
                eprintln!(
                    "[{}][FUSE] getxattr: EXIT ino={}, name={:?} -> NO_XATTR",
                    ts(),
                    ino.0,
                    name
                );
    ...
    fn listxattr(&self, _req: &Request, ino: INodeNo, size: u32, reply: ReplyXattr) {
        ...
        match handle_listxattr(self, ino.0, size) {
            XattrResult::Size(sz) => {
                eprintln!(
                    "[{}][FUSE] listxattr: EXIT ino={} -> size_query, total_len={}",
                    ts(),
                    ino.0,
                    sz
                );
            ...
            XattrResult::Data(buf) => {
                eprintln!(
                    "[{}][FUSE] listxattr: EXIT ino={} -> ok, total_len={}",
                    ts(),
                    ino.0,
                    buf.len()
                );
    ...
    fn setxattr(
        ...
        eprintln!(
            "[{}][FUSE] setxattr: ENTRY ino={}, name={:?}, value_len={}, flags={:#x}, position={}",
            ts(),
            ino.0,
            name,
            value.len(),
        ...
        match handle_setxattr(self, ino.0, name_str, value) {
            EmptyResult::Ok => {
                eprintln!(
                    "[{}][FUSE] setxattr: EXIT ino={}, name={:?} -> ok",
                    ts(),
                    ino.0,
                    name
                );
            ...
            EmptyResult::Error(errno) => {
                eprintln!(
                    "[{}][FUSE] setxattr: EXIT ino={}, name={:?} -> error {}",
                    ts(),
                    ino.0,
                    name,
                    errno
    ...
    fn removexattr(&self, _req: &Request, ino: INodeNo, name: &OsStr, reply: ReplyEmpty) {
        eprintln!(
            "[{}][FUSE] removexattr: ENTRY ino={}, name={:?}",
            ts(),
            ino.0,
            name
        );
        ...
        match handle_removexattr(self, ino.0, name_str) {
            EmptyResult::Ok => {
                eprintln!(
                    "[{}][FUSE] removexattr: EXIT ino={}, name={:?} -> ok",
                    ts(),
                    ino.0,
                    name
                );
            ...
            EmptyResult::Error(e) if e == libc::ENODATA => {
                eprintln!(
                    "[{}][FUSE] removexattr: EXIT ino={}, name={:?} -> NO_XATTR (not found)",
                    ts(),
                    ino.0,
                    name
                );
            ...
            EmptyResult::Error(errno) => {
                eprintln!(
                    "[{}][FUSE] removexattr: EXIT ino={}, name={:?} -> error {}",
                    ts(),
                    ino.0,
                    name,
                    errno
    ...
    fn write(
        ...
        eprintln!(
            "[{}][FUSE] write: ENTRY ino={}, fh={}, offset={}, data_len={}, write_flags={:#x}, flags={:#x}, lock_owner={:?}",
            ts(),
            ino.0,
            fh.0,
            offset,
        ...
        match handle_write(self, fh.0, offset, data) {
            WriteResult::Ok(n) => {
                eprintln!(
                    "[{}][FUSE] write: EXIT ino={}, fh={} -> ok, written={} bytes",
                    ts(),
                    ino.0,
                    fh.0,
                    n
    ...
    fn create(
        ...
        eprintln!(
            "[{}][FUSE] create: ENTRY parent={}, name={:?}, mode={:#o}, umask={:#o}, flags={:#x}, uid={}, gid={}",
            ts(),
            parent.0,
            name,
            mode,
        ...
        let name_str = match name.to_str() {
            ...
            None => {
                eprintln!(
                    "[{}][FUSE] create: EXIT parent={}, name={:?} -> EINVAL (invalid name)",
                    ts(),
                    parent.0,
                    name
                );
        ...
        match handle_create(
            ...
            CreateResult::Ok(ino, fh, attr) => {
                eprintln!(
                    "[{}][FUSE] create: EXIT parent={}, name={:?} -> ok, ino={}, fh={}, size={}, mode={:#o}",
                    ts(),
                    parent.0,
                    name,
                    ino,
            ...
            CreateResult::Error(errno) => {
                eprintln!(
                    "[{}][FUSE] create: EXIT parent={}, name={:?} -> error {}",
                    ts(),
                    parent.0,
                    name,
                    errno
    ...
    fn mkdir(
        ...
        eprintln!(
            "[{}][FUSE] mkdir: ENTRY parent={}, name={:?}, mode={:#o}, umask={:#o}, uid={}, gid={}",
            ts(),
            parent.0,
            name,
            mode,
        ...
        let name_str = match name.to_str() {
            ...
            None => {
                eprintln!(
                    "[{}][FUSE] mkdir: EXIT parent={}, name={:?} -> EINVAL",
                    ts(),
                    parent.0,
                    name
                );
        ...
        match handle_mkdir(self, parent.0, name_str, mode, umask, req.uid(), req.gid()) {
            EntryResult::Ok(ino, attr) => {
                eprintln!(
                    "[{}][FUSE] mkdir: EXIT parent={}, name={:?} -> ok, ino={}, mode={:#o}",
                    ts(),
                    parent.0,
                    name,
                    ino,
            ...
            EntryResult::Error(errno) => {
                eprintln!(
                    "[{}][FUSE] mkdir: EXIT parent={}, name={:?} -> error {}",
                    ts(),
                    parent.0,
                    name,
                    errno
    ...
    fn mknod(
        ...
        eprintln!(
            "[{}][FUSE] mknod: ENTRY parent={}, name={:?}, mode={:#o}, umask={:#o}, rdev={}, uid={}, gid={}",
            ts(),
            parent.0,
            name,
            mode,
        ...
        match handle_mknod(self, parent.0, name_str, mode, umask, req.uid(), req.gid()) {
            EntryResult::Ok(ino, attr) => {
                eprintln!(
                    "[{}][FUSE] mknod: EXIT parent={}, name={:?} -> ok, ino={}, mode={:#o}",
                    ts(),
                    parent.0,
                    name,
                    ino,
            ...
            EntryResult::Error(errno) => {
                eprintln!(
                    "[{}][FUSE] mknod: EXIT parent={}, name={:?} -> error {}",
                    ts(),
                    parent.0,
                    name,
                    errno
    ...
    fn symlink(
        ...
        eprintln!(
            "[{}][FUSE] symlink: ENTRY parent={}, link_name={:?}, target={:?}, uid={}, gid={}",
            ts(),
            parent.0,
            link_name,
            target,
        ...
        let name_str = match link_name.to_str() {
            ...
            None => {
                eprintln!(
                    "[{}][FUSE] symlink: EXIT parent={} -> EINVAL (invalid link_name)",
                    ts(),
                    parent.0
                );
                return reply.error(Errno::EINVAL);
        ...
        let target_str = match target.to_str() {
            ...
            None => {
                eprintln!(
                    "[{}][FUSE] symlink: EXIT parent={} -> EINVAL (invalid target)",
                    ts(),
                    parent.0
                );
                return reply.error(Errno::EINVAL);
        ...
        match handle_symlink(self, parent.0, name_str, target_str, req.uid(), req.gid()) {
            EntryResult::Ok(ino, attr) => {
                eprintln!(
                    "[{}][FUSE] symlink: EXIT parent={}, link_name={:?} -> ok, ino={}, size={}",
                    ts(),
                    parent.0,
                    link_name,
                    ino,
            ...
            EntryResult::Error(errno) => {
                eprintln!(
                    "[{}][FUSE] symlink: EXIT parent={}, link_name={:?} -> error {}",
                    ts(),
                    parent.0,
                    link_name,
                    errno
    ...
    fn link(
        ...
        eprintln!(
            "[{}][FUSE] link: ENTRY ino={}, newparent={}, newname={:?}",
            ts(),
            ino.0,
            newparent.0,
            newname
        ...
        let name_str = match newname.to_str() {
            ...
            None => {
                eprintln!(
                    "[{}][FUSE] link: EXIT ino={} -> EINVAL (invalid name)",
                    ts(),
                    ino.0
                );
                return reply.error(Errno::EINVAL);
        ...
        match handle_link(self, ino.0, newparent.0, name_str) {
            EntryResult::Ok(_new_ino, attr) => {
                eprintln!(
                    "[{}][FUSE] link: EXIT ino={}, newparent={}, newname={:?} -> ok, nlink={}",
                    ts(),
                    ino.0,
                    newparent.0,
                    newname,
    ...
    fn unlink(&self, _req: &Request, parent: INodeNo, name: &OsStr, reply: ReplyEmpty) {
        ...
        let name_str = match name.to_str() {
            ...
            None => {
                eprintln!(
                    "[{}][FUSE] unlink: EXIT parent={}, name={:?} -> EINVAL",
                    ts(),
                    parent.0,
                    name
                );
        ...
        match handle_unlink(self, parent.0, name_str) {
            EmptyResult::Ok => {
                eprintln!(
                    "[{}][FUSE] unlink: EXIT parent={}, name={:?} -> ok",
                    ts(),
                    parent.0,
                    name
                );
            ...
            EmptyResult::Error(errno) => {
                eprintln!(
                    "[{}][FUSE] unlink: EXIT parent={}, name={:?} -> error {}",
                    ts(),
                    parent.0,
                    name,
                    errno
    ...
    fn rmdir(&self, _req: &Request, parent: INodeNo, name: &OsStr, reply: ReplyEmpty) {
        ...
        let name_str = match name.to_str() {
            ...
            None => {
                eprintln!(
                    "[{}][FUSE] rmdir: EXIT parent={}, name={:?} -> EINVAL",
                    ts(),
                    parent.0,
                    name
                );
        ...
        match handle_rmdir(self, parent.0, name_str) {
            EmptyResult::Ok => {
                eprintln!(
                    "[{}][FUSE] rmdir: EXIT parent={}, name={:?} -> ok",
                    ts(),
                    parent.0,
                    name
                );
            ...
            EmptyResult::Error(errno) => {
                eprintln!(
                    "[{}][FUSE] rmdir: EXIT parent={}, name={:?} -> error {}",
                    ts(),
                    parent.0,
                    name,
                    errno
    ...
    fn rename(
        ...
        eprintln!(
            "[{}][FUSE] rename: ENTRY parent={}, name={:?}, newparent={}, newname={:?}, flags={:#x}",
            ts(),
            parent.0,
            name,
            newparent.0,
        ...
        match handle_rename(
            ...
            EmptyResult::Ok => {
                eprintln!(
                    "[{}][FUSE] rename: EXIT parent={}, name={:?} -> newparent={}, newname={:?} -> ok",
                    ts(),
                    parent.0,
                    name,
                    newparent.0,
            ...
            EmptyResult::Error(errno) => {
                eprintln!(
                    "[{}][FUSE] rename: EXIT parent={}, name={:?} -> error {}",
                    ts(),
                    parent.0,
                    name,
                    errno
    ...
    fn setattr(
        ...
        eprintln!(
            "[{}][FUSE] setattr: ENTRY ino={}, mode={:?}, uid={:?}, gid={:?}, size={:?}, mtime={:?}, fh={:?}",
            ts(),
            ino.0,
            ...
            gid,
            size,
            mtime.as_ref().map(|t| match t {
                TimeOrNow::Now => "Now".to_string(),
                TimeOrNow::SpecificTime(st) => format!("{:?}", st),
            }),
            fh.map(|f| f.0)
        );
        ...
        match handle_setattr(self, ino.0, mode, uid, gid, size, fh_val, mtime_pair) {
            AttrResult::Ok(attr) => {
                eprintln!(
                    "[{}][FUSE] setattr: EXIT ino={} -> ok, size={}, mode={:#o}, uid={}, gid={}",
                    ts(),
                    ino.0,
                    attr.size,
                    attr.perm,
    ...
    fn getlk(
        ...
        let type_str = match _typ {
            x if x == libc::F_RDLCK as i32 => "F_RDLCK",
            x if x == libc::F_WRLCK as i32 => "F_WRLCK",
            x if x == libc::F_UNLCK as i32 => "F_UNLCK",
            _ => "UNKNOWN",
        };
        eprintln!(
            "[{}][FUSE] getlk: ENTRY ino={}, fh={}, lock_owner={}, start={}, end={}, type={}({}), pid={}",
            ts(),
            ino.0,
            _fh.0,
            _lock_owner.0,
        ...
        match handle_getlk(start, end, pid) {
            LockResult::Ok(s, e, typ, p) => {
                eprintln!(
                    "[{}][FUSE] getlk: EXIT ino={}, fh={} -> F_UNLCK (no conflict)",
                    ts(),
                    ino.0,
                    _fh.0
                );
    ...
    fn setlk(
        ...
        eprintln!(
            "[{}][FUSE] setlk: ENTRY ino={}, fh={}, lock_owner={}, start={}, end={}, type={}({}), pid={}, sleep={}",
            ts(),
            ino.0,
            _fh.0,
            _lock_owner.0,
        ...
        eprintln!(
            "[{}][FUSE] setlk: EXIT ino={}, fh={} -> ok (no-op, single-threaded)",
            ts(),
            ino.0,
            _fh.0
        );
    ...
    fn fallocate(
        ...
        eprintln!(
            "[{}][FUSE] fallocate: ENTRY ino={}, fh={}, offset={}, length={}, mode={:#x}",
            ts(),
            _ino.0,
            _fh.0,
            _offset,
        ...
        eprintln!(
            "[{}][FUSE] fallocate: EXIT ino={} -> ENOSYS (not supported)",
            ts(),
            _ino.0
        );
